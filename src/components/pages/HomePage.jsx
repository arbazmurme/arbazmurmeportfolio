...
const HomeDetails = () => {
  return (
    <div className="relative flex flex-col lg:flex-row min-h-screen items-center text-white overflow-hidden">
      
      {/* 🔥 Animated Gradient Background */}
      <div className="absolute inset-0 -z-1 bg-gradient-to-br from-black via-[#111111] to-black animate-gradient bg-[length:400%_400%]" />
      ...
      <div className="hidden lg:flex lg:w-1/2 fixed h-screen items-center justify-center">
        ...
        <div className="relative flex items-center justify-center">
          ...
          {/* 💡 Soft Glow (Fixed layering) */}
          <div className="absolute -z-1 w-[520px] h-[620px] bg-[#ffb400] blur-[140px] opacity-15 rounded-full"></div>
          ...
          >
            <Image
              ...
              height={600}
              priority
              className="relative z-1 rounded-3xl shadow-2xl border border-white/20 hover:scale-105 transition duration-500"
            />
          </motion.div>
      ...
      {/* ================= RIGHT TEXT SECTION ================= */}
      <div className="relative w-full lg:w-1/2 lg:ml-auto px-6 lg:px-16 py-16 z-10">

        {/* Mobile Image */}
        <div className="lg:hidden mb-8 flex justify-center relative">
          <div className="absolute -z-1 w-60 h-60 bg-[#ffb400] blur-[80px] opacity-20 rounded-full"></div>
          <Image
            alt="hero"
            src="/arbazmurme.webp"
            width={280}
        ...
        <motion.h1
          ...
          transition={{ duration: 1 }}
          className="text-4xl lg:text-6xl font-extrabold uppercase leading-tight z-0"
        >
